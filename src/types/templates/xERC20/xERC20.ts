...
export class xERC20__getAccountSnapshotResult {
  value0: BigInt
  value1: BigInt
  value2: BigInt
  value3: BigInt
...
export class xERC20 extends ethereum.SmartContract {
  static bind(address: Address): xERC20 {
    return new xERC20('xERC20', address)
  }

  NO_ERROR(): BigInt {
    let result = super.call('NO_ERROR', 'NO_ERROR():(uint256)', [])

    return result[0].toBigInt()
  }

  try_NO_ERROR(): ethereum.CallResult<BigInt> {
    let result = super.tryCall('NO_ERROR', 'NO_ERROR():(uint256)', [])
    if (result.reverted) {
  ...
  try__addReserves(addAmount: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall('_addReserves', '_addReserves(uint256):(uint256)', [
      ethereum.Value.fromUnsignedBigInt(addAmount),
    ])
    if (result.reverted) {
      return new ethereum.CallResult()
  ...
  _reduceReserves(reduceAmount: BigInt): BigInt {
    let result = super.call('_reduceReserves', '_reduceReserves(uint256):(uint256)', [
  ...
  try__reduceReserves(reduceAmount: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall('_reduceReserves', '_reduceReserves(uint256):(uint256)', [
      ethereum.Value.fromUnsignedBigInt(reduceAmount),
    ])
    if (result.reverted) {
      return new ethereum.CallResult()
  ...
  _setComptroller(newComptroller: Address): BigInt {
    let result = super.call('_setComptroller', '_setComptroller(address):(uint256)', [
  ...
  try__setComptroller(newComptroller: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall('_setComptroller', '_setComptroller(address):(uint256)', [
      ethereum.Value.fromAddress(newComptroller),
    ])
    if (result.reverted) {
      return new ethereum.CallResult()
  ...
  try__setInterestRateModel(newInterestRateModel: Address): ethereum.CallResult<BigInt> {
  ...
  _setReserveFactor(newReserveFactorMantissa: BigInt): BigInt {
    let result = super.call('_setReserveFactor', '_setReserveFactor(uint256):(uint256)', [
  ...
  try__setReserveFactor(newReserveFactorMantissa: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      '_setReserveFactor',
  ...
  exchangeRateCurrent(): BigInt {
    let result = super.call('exchangeRateCurrent', 'exchangeRateCurrent():(uint256)', [])
  ...
  getAccountSnapshot(account: Address): xERC20__getAccountSnapshotResult {
    let result = super.call(
      'getAccountSnapshot',
    ...
    return new xERC20__getAccountSnapshotResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getAccountSnapshot(
    account: Address,
  ): ethereum.CallResult<xERC20__getAccountSnapshotResult> {
    let result = super.tryCall(
      'getAccountSnapshot',
      'getAccountSnapshot(address):(uint256,uint256,uint256,uint256)',
      [ethereum.Value.fromAddress(account)],
    ...
    return ethereum.CallResult.fromValue(
      new xERC20__getAccountSnapshotResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  redeemUnderlying(redeemAmount: BigInt): BigInt {
    let result = super.call('redeemUnderlying', 'redeemUnderlying(uint256):(uint256)', [
  ...
  try_repayBorrow(repayAmount: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall('repayBorrow', 'repayBorrow(uint256):(uint256)', [
      ethereum.Value.fromUnsignedBigInt(repayAmount),
    ])
    if (result.reverted) {
      return new ethereum.CallResult()
  ...
  seize(liquidator: Address, borrower: Address, seizeTokens: BigInt): BigInt {
    let result = super.call('seize', 'seize(address,address,uint256):(uint256)', [
  ...
  try_seize(
    ...
    let result = super.tryCall('seize', 'seize(address,address,uint256):(uint256)', [
      ethereum.Value.fromAddress(liquidator),
      ethereum.Value.fromAddress(borrower),
      ethereum.Value.fromUnsignedBigInt(seizeTokens),
    ])
  ...
  totalBorrowsCurrent(): BigInt {
    let result = super.call('totalBorrowsCurrent', 'totalBorrowsCurrent():(uint256)', [])
