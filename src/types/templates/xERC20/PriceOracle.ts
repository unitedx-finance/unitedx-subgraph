...
export class PriceOracle__aggregatorsResult {
  value0: Address
  value1: Bytes
...
export class PriceOracle extends ethereum.SmartContract {
  ...
  aggregators(param0: Address): PriceOracle__aggregatorsResult {
    let result = super.call('aggregators', 'aggregators(address):(address,bytes)', [
      ethereum.Value.fromAddress(param0),
    ])

    return new PriceOracle__aggregatorsResult(result[0].toAddress(), result[1].toBytes())
  }

  try_aggregators(param0: Address): ethereum.CallResult<PriceOracle__aggregatorsResult> {
    ...
    return ethereum.CallResult.fromValue(
      new PriceOracle__aggregatorsResult(value[0].toAddress(), value[1].toBytes()),
    )
  }
