...
export class Comptroller extends ethereum.SmartContract {
  ...
  try__setComptrollerLens(
    comptrollerLens_: Address
  ): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "_setComptrollerLens",
      "_setComptrollerLens(address):(uint256)",
  ...
  _setVAIMintRate(newVAIMintRate: BigInt): BigInt {
    let result = super.call(
      "_setVAIMintRate",
      "_setVAIMintRate(uint256):(uint256)",
  ...
  try_venusBorrowState(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Comptroller__venusBorrowStateResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  try_venusSupplyState(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Comptroller__venusSupplyStateResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
